...
run_test:
	gcc ./src/core.c ./src/file.c ./src/game.c ./src/global.c ./src/grid.c ./src/input.c ./src/log.c ./src/options.c ./src/pawn.c ./src/render.c ./src/resource.c ./src/utilities.c ./src/windowmanager.c ./src/test/*.c -lcmocka -lpanel -lncursesw -o ./bin/cc_tests && ./bin/cc_tests
